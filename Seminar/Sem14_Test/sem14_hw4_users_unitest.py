...
# Запускать тесты не надо, автотест это сделает сам:  unittest.main()
# На выходе после автоматической обрезки информации в тестах вы должны получить: FAILED (failures=1)
...
class TestEmployee(unittest.TestCase): 
    ...
    def test_employee_raise_salary(self):
        ...
        self.assertEqual(round(self.emp.salary, 1), 55000.0)
